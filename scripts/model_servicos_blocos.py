...
print("2. A agregar e treinar modelos para os 4 blocos...")
resultados_blocos = []
...
print("\n==================================================================")
print("SERVIÇOS DE INFORMAÇÃO E COMUNICAÇÃO (Setor J) - Choque em 2022")
print("==================================================================\n")

analise_j = df_final[(df_final['TIME_PERIOD'] == 2022) & (df_final['ACTIVITY'] == 'J')]
print(analise_j[['REF_AREA', 'ACTIVITY', 'TIME_PERIOD', 'Produtividade_Trabalho', 'Choque_Estrutural_Percentual']])

print("\n==================================================================")
print("SERVIÇOS FINANCEIROS E DE SEGUROS (Setor K) - Choque em 2022")
print("==================================================================\n")

analise_k = df_final[(df_final['TIME_PERIOD'] == 2022) & (df_final['ACTIVITY'] == 'K')]
if not analise_k.empty:
    print(analise_k[['REF_AREA', 'ACTIVITY', 'TIME_PERIOD', 'Produtividade_Trabalho', 'Choque_Estrutural_Percentual']])
else:
    print("Dados para o setor 'K' não disponíveis para todos os blocos nesta extração.")