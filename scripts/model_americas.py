...
# 1.1 Atualizamos os blocos para incluir as Américas (OCDE)
blocos = {
    ...
    'AMERICAS_OCDE': ['USA', 'CAN', 'MEX', 'CHL', 'COL', 'CRI'] # Países das Américas na OCDE
}
...
analise_comercio = df_final[(df_final['TIME_PERIOD'] == 2022) & (df_final['ACTIVITY'] == 'G')]
...
analise_industria = df_final[(df_final['TIME_PERIOD'] == 2022) & (df_final['ACTIVITY'] == 'C')]
